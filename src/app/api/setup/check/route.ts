    ...
    switch (check) {
      case 'Docker is running':
        try {
          ...
          result = { success: true, message: 'Docker is running and accessible' }
        } catch (error) {
          result = { success: false, message: 'Docker is not running or not accessible' }
        }
        break
      ...
      case 'Project directory writable':
        try {
          ...
          result = { success: false, message: 'Cannot write to project directory' }
        }
        break
      ...
      case 'nself CLI available':
        try {
          ...
          if (stdout.trim()) {
            result = { success: true, message: 'nself CLI found and accessible' }
          } else {
