    ...
    const mockRuns: GitHubWorkflowRun[] = [
      {
        ...
        status: 'completed',
        conclusion: 'success',
        htmlUrl: 'https://github.com/acamarata/nself-admin/actions/runs/1',
        runNumber: 345,
        event: 'push',
      ...
      },
      {
        ...
        headSha: 'b2c3d4e',
        status: 'in_progress',
        htmlUrl: 'https://github.com/acamarata/nself/actions/runs/2',
        runNumber: 892,
        event: 'push',
      ...
      },
      {
        ...
        status: 'completed',
        conclusion: 'failure',
        htmlUrl: 'https://github.com/acamarata/nself-admin/actions/runs/3',
        runNumber: 344,
        event: 'pull_request',
      ...
      },
      {
        ...
        status: 'completed',
        conclusion: 'success',
        htmlUrl: 'https://github.com/acamarata/nself/actions/runs/4',
        runNumber: 891,
        event: 'push',
      ...
      },
      {
        ...
        status: 'completed',
        conclusion: 'success',
        htmlUrl: 'https://github.com/acamarata/nself-admin/actions/runs/5',
        runNumber: 12,
        event: 'release',
      ...
      },
      {
        ...
        status: 'completed',
        conclusion: 'success',
        htmlUrl: 'https://github.com/acamarata/nself/actions/runs/6',
        runNumber: 890,
        event: 'pull_request',
      ...
      },
      {
        ...
        status: 'completed',
        conclusion: 'success',
        htmlUrl: 'https://github.com/acamarata/nself-admin/actions/runs/7',
        runNumber: 156,
        event: 'schedule',
      ...
      },
      {
        ...
        status: 'completed',
        conclusion: 'failure',
        htmlUrl: 'https://github.com/acamarata/nself/actions/runs/8',
        runNumber: 889,
        event: 'push',
      ...
      },
      {
        ...
        status: 'completed',
        conclusion: 'success',
        htmlUrl: 'https://github.com/acamarata/nself-admin/actions/runs/9',
        runNumber: 343,
        event: 'pull_request',
      ...
      },
      {
        ...
        status: 'completed',
        conclusion: 'success',
        htmlUrl: 'https://github.com/acamarata/nself/actions/runs/10',
        runNumber: 888,
        event: 'push',
