    ...
    const mockRepos: GitHubRepo[] = [
      {
        id: 1,
        name: 'nself',
        fullName: 'acamarata/nself',
        description: 'Self-hosted development platform',
        private: false,
        htmlUrl: 'https://github.com/acamarata/nself',
        cloneUrl: 'https://github.com/acamarata/nself.git',
        language: 'TypeScript',
        stargazersCount: 234,
        forksCount: 45,
        openIssuesCount: 12,
      ...
      },
      {
        id: 2,
        name: 'nself-admin',
        fullName: 'acamarata/nself-admin',
        description: 'Web UI for nself CLI management',
        private: false,
        htmlUrl: 'https://github.com/acamarata/nself-admin',
        cloneUrl: 'https://github.com/acamarata/nself-admin.git',
        language: 'TypeScript',
        stargazersCount: 89,
        forksCount: 12,
        openIssuesCount: 8,
      ...
      },
      {
        id: 3,
        name: 'api-gateway',
        fullName: 'acamarata/api-gateway',
        description: 'Modern API gateway with rate limiting and auth',
        private: true,
        htmlUrl: 'https://github.com/acamarata/api-gateway',
        cloneUrl: 'https://github.com/acamarata/api-gateway.git',
        language: 'Go',
        stargazersCount: 156,
        forksCount: 28,
        openIssuesCount: 5,
      ...
      },
      {
        ...
        fullName: 'acamarata/analytics-dashboard',
        description: 'Real-time analytics and visualization platform',
        private: false,
        htmlUrl: 'https://github.com/acamarata/analytics-dashboard',
        cloneUrl: 'https://github.com/acamarata/analytics-dashboard.git',
        language: 'Python',
        stargazersCount: 312,
        forksCount: 67,
        openIssuesCount: 18,
      ...
      },
      {
        ...
        fullName: 'acamarata/microservice-starter',
        description: 'Production-ready microservice template with Docker',
        private: false,
        htmlUrl: 'https://github.com/acamarata/microservice-starter',
        cloneUrl: 'https://github.com/acamarata/microservice-starter.git',
        language: 'JavaScript',
        stargazersCount: 445,
        forksCount: 92,
        openIssuesCount: 24,
      ...
      },
      {
        id: 6,
        name: 'rust-cli-tools',
        fullName: 'acamarata/rust-cli-tools',
        description: 'Collection of CLI utilities written in Rust',
        private: false,
        htmlUrl: 'https://github.com/acamarata/rust-cli-tools',
        cloneUrl: 'https://github.com/acamarata/rust-cli-tools.git',
        language: 'Rust',
        stargazersCount: 678,
        forksCount: 134,
        openIssuesCount: 0,
