    ...
    const mockIssues: GitHubIssue[] = [
      {
        ...
        state: 'open',
        htmlUrl: 'https://github.com/acamarata/nself-admin/issues/145',
        userId: 1001,
      ...
      },
      {
        ...
        state: 'open',
        htmlUrl: 'https://github.com/acamarata/nself/issues/143',
        userId: 1002,
      ...
      },
      {
        ...
        state: 'open',
        htmlUrl: 'https://github.com/acamarata/nself/issues/140',
        userId: 1003,
      ...
      },
      {
        ...
        state: 'closed',
        htmlUrl: 'https://github.com/acamarata/nself/issues/138',
        userId: 1001,
        userLogin: 'developer1',
        labels: ['enhancement'],
        assignees: ['developer1'],
      ...
      },
      {
        ...
        state: 'open',
        htmlUrl: 'https://github.com/acamarata/nself/issues/135',
        userId: 1004,
        userLogin: 'user123',
      ...
      },
      {
        ...
        state: 'open',
        htmlUrl: 'https://github.com/acamarata/nself/issues/132',
        userId: 1002,
        userLogin: 'developer3',
      ...
      },
      {
        ...
        state: 'closed',
        htmlUrl: 'https://github.com/acamarata/nself/issues/130',
        userId: 1003,
        userLogin: 'contributor1',
        labels: ['bug', 'priority-high'],
      ...
      },
      {
        ...
        state: 'open',
        htmlUrl: 'https://github.com/acamarata/nself-admin/issues/128',
        userId: 1001,
        userLogin: 'developer1',
