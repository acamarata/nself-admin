    ...
    const mockPRs: GitHubPullRequest[] = [
      {
        ...
        state: 'open',
        htmlUrl: 'https://github.com/acamarata/nself-admin/pulls/89',
        userId: 1001,
      ...
      },
      {
        ...
        state: 'merged',
        htmlUrl: 'https://github.com/acamarata/nself/pulls/87',
        userId: 1002,
      ...
      },
      {
        ...
        state: 'open',
        htmlUrl: 'https://github.com/acamarata/nself-admin/pulls/85',
        userId: 1003,
      ...
      },
      {
        ...
        state: 'merged',
        htmlUrl: 'https://github.com/acamarata/nself/pulls/83',
        userId: 1001,
        userLogin: 'developer1',
      ...
      },
      {
        ...
        state: 'open',
        htmlUrl: 'https://github.com/acamarata/nself/pulls/81',
        userId: 1004,
      ...
      },
      {
        ...
        state: 'closed',
        htmlUrl: 'https://github.com/acamarata/nself-admin/pulls/79',
        userId: 1002,
        userLogin: 'developer3',
      ...
      },
      {
        ...
        state: 'merged',
        htmlUrl: 'https://github.com/acamarata/nself-admin/pulls/77',
        userId: 1001,
        userLogin: 'developer1',
      ...
      },
      {
        ...
        state: 'merged',
        htmlUrl: 'https://github.com/acamarata/nself-admin/pulls/75',
        userId: 1003,
