    ...
    try {
      ...
      if (data.success) {
        ...
        setStatus({
          ...
          secretsConfigured: output.includes('secrets: configured') || output.includes('.env.secrets: found'),
          hasuraConsoleDisabled: output.includes('console: disabled') || output.includes('HASURA.*CONSOLE.*false'),
    ...
    <>
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mb-8 grid gap-6 md:grid-cols-4">
          ...
          <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
            <div className="flex items-center gap-3">
              <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${status?.sslEnabled ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30'}`}>
                <svg className={`h-5 w-5 ${status?.sslEnabled ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
              <div>
                <p className="text-sm text-zinc-500 dark:text-zinc-400">SSL</p>
                <p className={`font-semibold ${status?.sslEnabled ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
          ...
          <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
            <div className="flex items-center gap-3">
              <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${status?.secretsConfigured ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30'}`}>
                <svg className={`h-5 w-5 ${status?.secretsConfigured ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                </svg>
              </div>
              <div>
                <p className="text-sm text-zinc-500 dark:text-zinc-400">Secrets</p>
                <p className={`font-semibold ${status?.secretsConfigured ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
          ...
          <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
            <div className="flex items-center gap-3">
              <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${status?.debugDisabled ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30'}`}>
                <svg className={`h-5 w-5 ${status?.debugDisabled ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                </svg>
              </div>
              <div>
                <p className="text-sm text-zinc-500 dark:text-zinc-400">Debug</p>
                <p className={`font-semibold ${status?.debugDisabled ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
        ...
        {status?.domain && (
          <div className="mb-8 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
            <h3 className="mb-4 text-lg font-semibold text-zinc-900 dark:text-white">Production Domain</h3>
        ...
        {showInitForm && (
          <div className="mb-8 rounded-xl border border-blue-200 bg-blue-50 p-6 dark:border-blue-800 dark:bg-blue-900/20">
            <h3 className="mb-4 text-lg font-semibold text-zinc-900 dark:text-white">Initialize Production Environment</h3>
            <form onSubmit={handleInit} className="space-y-4">
              <div>
                <label className="mb-1 block text-sm font-medium text-zinc-700 dark:text-zinc-300">Production Domain *</label>
                <input
                  type="text"
                  value={initDomain}
        ...
        {actionResult && (
          <div className={`mb-8 rounded-xl border p-6 ${actionResult.success ? 'border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-900/20' : 'border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/20'}`}>
            <div className="flex items-start gap-3">
              ...
              <button onClick={() => setActionResult(null)} className="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {/* Setup Actions */}
          <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
            <h3 className="mb-4 text-lg font-semibold text-zinc-900 dark:text-white">Setup & Configuration</h3>
          ...
          {/* SSL Actions */}
          <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
            <h3 className="mb-4 text-lg font-semibold text-zinc-900 dark:text-white">SSL Certificates</h3>
            <div className="grid gap-3">
              <button
              ...
              <button
                onClick={() => executeAction('ssl', { sslAction: 'request', domain: status?.domain })}
              ...
              >
                ...
                {actionLoading === 'ssl-request' ? 'Requesting...' : 'Request Let\'s Encrypt Certificate'}
              </button>
        ...
        <div className="mt-8 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          <h3 className="mb-4 text-lg font-semibold text-zinc-900 dark:text-white">Production Checklist</h3>
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <div className={`h-5 w-5 rounded-full ${status?.configured ? 'bg-green-500' : 'bg-zinc-300'}`}>
                {status?.configured && <svg className="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>}
              </div>
              <span className="text-zinc-700 dark:text-zinc-300">Initialize production environment</span>
            </div>
            <div className="flex items-center gap-3">
              <div className={`h-5 w-5 rounded-full ${status?.secretsConfigured ? 'bg-green-500' : 'bg-zinc-300'}`}>
                {status?.secretsConfigured && <svg className="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>}
              </div>
              <span className="text-zinc-700 dark:text-zinc-300">Generate production secrets</span>
            </div>
            <div className="flex items-center gap-3">
              <div className={`h-5 w-5 rounded-full ${status?.sslEnabled ? 'bg-green-500' : 'bg-zinc-300'}`}>
                {status?.sslEnabled && <svg className="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>}
              </div>
              <span className="text-zinc-700 dark:text-zinc-300">Configure SSL certificates</span>
            </div>
            <div className="flex items-center gap-3">
              <div className={`h-5 w-5 rounded-full ${status?.debugDisabled ? 'bg-green-500' : 'bg-zinc-300'}`}>
                {status?.debugDisabled && <svg className="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>}
              </div>
